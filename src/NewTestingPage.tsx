...
import { calculateTesting, defaultConfig, filterNearOrderblock } from './sm-lib/th_ultimate';
...
const NewTestingPage = () => {
  ...
  let { swings, trend, boses, orderBlocks } = calculateTesting(
    data.slice(0, data.length - offset),
    env === 'prod' ? defaultConfig : newStruct,
  );
