      ...
      {tab === 'forex-local' && (
        <>
          <Row gutter={[8, 8]}>
            ...
            <Col span={span}>
              <StatArbPage tickerStock="BR-8.25" _tickerFuture="BRNUSD_xp" multi={10000} onlyChart height={height} />
            </Col>
            <Col span={span}>
              <StatArbPage tickerStock="NG-8.25" _tickerFuture="NGCUSD_xp" multi={1000} onlyChart height={height} />
            </Col>
            <Col span={span}>
