...
export const SPBXPage = ({ tickerStock: _tickerStock, _tickerFuture, leftExchange = 'MOEX', righExchange = 'MOEX' }) => {
  ...
  const tickerStock = searchParams.get('ticker-stock') || _tickerStock;
  const tickerFuture = searchParams.get('ticker-stock') || _tickerStock;
