...
export const OrdersTable: FC<{pageSize: number, orders: any[], onSelect: (row: any) => void, ordersMap: any}> = ({pageSize, onSelect, orders, ordersMap}) => {
    ...
    return <Table size="small" dataSource={orders} columns={columns}
                  pagination={{
                      pageSize,
                  }}
                  onRow={(record: any) => {
