...
export const checkNewExtremum = (manager: StateManager, swing: Swing) => {
...
export const checkSomeNewSwing = (
    swing: Swing,
    isHighest: boolean,
    isLowest: boolean,
...
export function processDoubleSwing(
    manager: StateManager,
    swing: Swing,
    isHighest: boolean,
    isLowest: boolean
...
// Установка нового экстремума
export function setNewLastExtremum(
    manager: StateManager,
