...
function SidebarProvider({
  ...
  const [_open, _setOpen] = React.useState(
    localStorage.getItem(SIDEBAR_COOKIE_NAME) ? localStorage.getItem(SIDEBAR_COOKIE_NAME) === 'true' : defaultOpen,
  );
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'fixed inset-y-0 z-10 hidden mt-[38px] h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex',
          side === 'left'
